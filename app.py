    ...
    def on_message(self, data):
        ...
        */
        ...
        try:
            ...
            player = self.application.game.get_player(name =  user_name,
                                             hash = user_hash)
            if not player:
                self.close()
            ...
            #set HMSET new hash to redis - overwrite all fields if key exists otherwise write new hash
